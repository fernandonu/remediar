...
if ($_POST['guardar'] == "Guardar Prestacion") {
    ...
    if ($val->RecordCount() == 0) {
        ...
        $accion = "Ya esta cargada la prestacion $nomenclador, para este efector.";
                ...
                <table class="bordes" align="center" width="70%">
                    ...
                    <tr><td class="bordes"><table>
                                ...
                                <tr>
									...
									inner join nacer.efe_conv using (id_nomenclador_detalle)
									Where nacer.efe_conv.CUIE = '" . $cuie . "' 
...
$query = "SELECT * FROM facturacion.efec_nom
  ...
  inner join nacer.efe_conv  on facturacion.efec_nom.cuie=nacer.efe_conv.cuie
  where nacer.efe_conv.cuie='$cuie'
