   ...
   if (($pagina_viene=='comprobante_admin_total.php')||((valida_prestacion($id_comprobante,$nomenclador))&&(valida_prestacion1($id_comprobante,$nomenclador)))){
	   $db->StartTrans();
	    ...
	    $query="insert into facturacion.prestacion
	             ...
	             values
	             ($id_prestacion,$id_comprobante,$nomenclador,$cantidad,$precio_prestacion,$anexo,'0','00/00')";
					    	...
					    	?>		          			
			                 ...
			                 $sql= "select * 
									...
									where cuie='$cuie' and 
										  ...
										  n.codigo<>'DIFERENCIA DE NOMENCLADOR' and
										  n.codigo<>'DEB-CRED' and 
										  n.grupo<>'$grupo_nomenclador'
			                 		ORDER BY n.codigo";
			                 }
			                 else {
