       ...
       <td>
		...
		<tr>
		    ...
		    <td align="left">
		    	 ...
		    	 <input type=text id=fecha_control name=fecha_control value='<?=fecha($fecha_control);   ?>' size=15 <? if ($id_planilla) echo "readonly" ?> >
        ...
        <tr>
		    ...
		    <td align="left">
		    	<?$fecha_comprobante=date("d/m/Y");?>
		    	 <input type=text id=fum name=fum value='<?=fecha($fum);?>' size=15 <? if ($id_planilla) echo "readonly" ?>>
		    	 <?=link_calendario("fum");?>					    	 
		    </td>		    
		</tr>    
		...
		<tr>
		    ...
		    <td align="left">
		    	<?$fecha_comprobante=date("d/m/Y");?>
		    	 <input type=text id=fpp name=fpp value='<?=fecha($fpp); ?>' size=15 <?  if ($id_planilla) echo "readonly" ?>>
		    	 <?=link_calendario("fpp");?>					    	 
		    </td>		    
		</tr>   
		...
		<tr>
		    ...
		    <td align="left">
		    	<?$fecha_comprobante=date("d/m/Y");?>
		    	 <input type=text id=fpcp name=fpcp value='<?=fecha($fpcp); ?>' size=15 <?  if ($id_planilla) echo "readonly" ?>>
