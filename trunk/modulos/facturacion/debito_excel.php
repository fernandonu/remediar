...
INFORME DE PRESTACIONES <?php if($estado == 'A') echo '<span style="color:red;">(FACTURA ABIERTA)</span>' ?> 
                </b></font>
            </td>
        </tr>
        <tr bgcolor="#f6bebe">
    ...
    <table width="100%" align=center border=1 bordercolor=#585858 cellspacing="0" cellpadding="5">
        ...
        <? while (!$result->EOF) {
            ...
            <tr>
                ...
                <td><?php echo $result->fields['id_motivo_d'] != 0 ? $result->fields['descripcion'] : $result->fields['mensaje_baja'] ?></td>
